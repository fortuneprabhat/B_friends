...
public class SystemTest {
	...
	public void createReadDelete() {
		...
		String url = "http://localhost:8081/friend";
		
		Friend friend = new Friend("Prabhat","Kumar");
		...
		Assertions.assertThat(friends).extracting(Friend::getFirstName).containsOnly("Prabhat");
